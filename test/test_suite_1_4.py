...
class ServerSideCursorsTest(_ServerSideCursorsTest):
    ...
    # )
    @testing.skip("starrocks", 'Not on 1.4')
...
HasIndexTest.__requires__ = ('index_reflection',) # make skip on 1.4.*
LikeFunctionsTest.__requires__ = ('like_escapes',) # make skip on 1.4.*
